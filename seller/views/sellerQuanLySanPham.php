...
<head>
    ...
    <style>
        ...
        /* Custom Table & Button */
        .seller-table th { background-color: var(--bs-pink-500) !important; color: white; text-align: center; vertical-align: middle; }
        .seller-table td { vertical-align: middle; }
        .btn-pink { background-color: var(--bs-pink-500); color: white; border: none; }
        .btn-pink:hover { background-color: var(--bs-pink-600); color: white; }
