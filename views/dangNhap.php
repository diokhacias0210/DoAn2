...
<body>
    ...
    <div class="giua-trang">
        ...
        <div class="than-phai">
            <form method="POST" action="dangNhapController.php">

                <div class="bieu-mau-tren">
                    <div class="bieu-mau" id="loginForm">
                        <h2 style="padding-bottom: 48px;">| Đăng Nhập</h2>

                        <div class="bieu-mau-noi">
                            <input type="email" id="loginEmail" name="email" placeholder=" " autocomplete="off"
                        ...
                        <div class="bieu-mau-noi">
                            <input type="password" id="loginPassword" name="password" placeholder=" " autocomplete="off">
                ...
                <div class="bieu-mau-duoi">
                    ...
                    <div class="chuyen-toi-dang-ky">
                        Chưa có tài khoản?<a href="dangKyController.php"> <u>Đăng ký ở đây</u></a>
                    </div>
                    <div style="display:flex; justify-content: center; margin: 24px 0">Hoặc tiếp tục với Google</div>
                    <hr>
                    <div class="dang-nhap-google">
                        <a href="../project/public/google_login.php" style="text-decoration: none; width:200px;">
